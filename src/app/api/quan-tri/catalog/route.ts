...
export async function GET(req: Request) {
  ...
  if (!id) {
    let q = db.from("catalog").select("id,tieu_de,duong_dan,trang_thai,ngay_cap_nhat,nguoi_tao_id,de_muc(ten_de_muc),de_muc_con(ten_de_muc_con)").is("ngay_xoa",null).order("ngay_cap_nhat",{ascending:false});
